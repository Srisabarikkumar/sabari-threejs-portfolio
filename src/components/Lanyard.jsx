...
export default function Lanyard({position = [0, 0, 30], gravity = [0, 0, 0], fov = 20, transparent = false}) {
    return (
        <div
            className="absolute z-0 w-fit h-fit flex justify-center items-center transform scale-100 origin-center">
            <Canvas
